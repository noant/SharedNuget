...
rootCommand.SetHandler(async (projectName, apiKey, source) =>
{
    var publisher = new NugetPublisher(projectName, apiKey, source);
    await publisher.PublishAsync();
}, projectNameOption, apiKeyOption, sourceOption);
